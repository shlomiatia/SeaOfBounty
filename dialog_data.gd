class_name DialogData extends RefCounted
...
# Level 8 dialogs
static var level_8_miguel: Array[String] = [
	"To battle, my friend! Charge!!!"
]

static var level_8_constantine: Array[String] = [
...
# Level 10 dialogs
static var level_10_miguel: Array[String] = [
	"An ambush!"
]

static var level_10_lia: Array[String] = [
	"They want to flee, we're just in the way."
]

static var level_10_constantine: Array[String] = [
	"Bad luck for them!"
]
...
# Level 12 dialogs
static var level_12_constantine_1: Array[String] = [
	"This is the one?"
]

static var level_12_lia_1: Array[String] = [
	"This is it."
]

static var level_12_constantine_2: Array[String] = [
	"We are going to die."
]

static var level_12_miguel: Array[String] = [
	"At least we'll die together!"
]

static var level_12_orphan_1: Array[String] = [
	"You guys wanted to die without us??"
]

static var level_12_one_eye: Array[String] = [
	"Kate! Finn! You made it!"
]

static var level_12_fisherman: Array[String] = [
	"Just in time for the last battle. Ready?"
]

static var level_12_lia_2: Array[String] = [
	"Yes!"
]

static var level_12_constantine_3: Array[String] = [
	"Yes!"
]

static var level_12_miguel_2: Array[String] = [
	"Yes!"
]

static var level_12_one_eye_2: Array[String] = [
	"Yes!"
]

static var level_12_orphan_2: Array[String] = [
	"Yes!"
]
...
static func get_tutorial_level2_text(step: int) -> String:
	match step:
		0:
...
# Tutorial texts - Level 6
static func get_tutorial_level6_text(step: int) -> String:
	match step:
		0:
			return "Select Lia."
		1:
...
static func get_tutorial_level8_text(step: int) -> String:
	match step:
		...
		1:
			return "Press %s to skip hero turn."
		_:
			return ""
